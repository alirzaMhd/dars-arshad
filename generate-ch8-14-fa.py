#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate comprehensive Persian (Farsi) study guide for Chapters 8-14 of AIMA.

Output: /content/dars-arshad/chapters-8-14-fa.md
"""

OUT = "/content/dars-arshad/chapters-8-14-fa.md"

content = r"""# راهنمای جامع امتحانی — هوش مصنوعی: رویکردی مدرن (ویرایش چهارم)
...
print("Writing Persian study guide for chapters 8-14...")
with open(OUT, "w", encoding="utf-8") as f:
    f.write(content)

lines = sum(1 for _ in open(OUT, encoding="utf-8"))
print(f"Done! Written {lines} lines to {OUT}")
